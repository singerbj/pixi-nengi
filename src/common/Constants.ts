...
export const ENTITY_JUMP_SPEED_AND_GRAVITY = 425;
export const FOLLOW_X_BUDGET_FACTOR = 1.1;
export const FOLLOW_Y_BUDGET_FACTOR = 1.1;
export const MAX_FOLLOW_DISTANCE = 20;
...
export const LAST_JUMP_DELAY = 30 / 100;
